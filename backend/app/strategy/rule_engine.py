...
DEFAULT_RULES = [
    ...
    },
    {
        ...
        "conditions": [
            ...
            {"indicator": "low_below_ema20_1h", "operator": "==", "value": True},
        ],
        "logic": "AND",
    ...
    },
    {
        "id": 1001,
        "rule_code": "Aa13",
        "name": "EMA20 Pullback Sniper 15m (EMA3>EMA9>EMA20)",
        "description": "Compra inmediata al cruzar/tocar EMA20 en 15m con alineación EMA3 > EMA9 > EMA20 y separación activa entre EMA3 y EMA9.",
        "direction": "long",
        ...
        "entry_trades": [1],
        "conditions": [
            {"indicator": "price_touches_ema20_15m_long", "operator": "==", "value": True},
            {"indicator": "ema3_above_ema9_15m", "operator": "==", "value": True},
            {"indicator": "ema9_above_ema20_15m", "operator": "==", "value": True},
            {"indicator": "ema3_ema9_gap_sufficient_15m", "operator": "==", "value": True},
            {"indicator": "ema20_slope_positive_15m", "operator": "==", "value": True},
        ],
        "logic": "AND",
        "notes": "Entrada rápida y óptima al retroceso en EMA20 con tendencia intacta y separación de medias.",
    },
    ...
    },
    {
        ...
        "conditions": [
            ...
            {"indicator": "ema20_angle", "operator": "<=", "value": 0},
            {"indicator": "di_minus_above_di_plus", "operator": "==", "value": True},
            {"indicator": "rsi_14", "operator": "<=", "value": 60},
        ],
        "logic": "AND",
        "notes": "SHORT EMA50 cruza basis confirmado con EMA9 < EMA20 y 5m. (v3 forced)",
    },
    {
        "id": 1142,
        "rule_code": "Bb41",
        "name": "SHORT BB41: ANTIGRAVITY CANDLE SELL",
        "description": "Detección de patrones de velas 4H/1D + Filtro Fib Zone y confirmación bajista.",
        "direction": "short",
        "market_type": ["crypto_spot", "crypto_futures"],
        "ema50_vs_ema200": "below",
        "enabled": True,
        ...
        "logic": "AND",
        "notes": "SHORT confirmado con alineación 15m/5m, ángulo EMA20 y DI- > DI+. (v3 forced)",
    },
    {
        "id": 1009,
        "rule_code": "Bb13",
        "name": "EMA20 Pullback Sniper Short 15m (EMA3<EMA9<EMA20)",
        "description": "Venta inmediata al cruzar/tocar EMA20 en 15m con alineación EMA3 < EMA9 < EMA20 y separación activa entre EMA3 y EMA9.",
        "direction": "short",
        "market_type": ["crypto_spot", "crypto_futures", "forex_futures"],
        "ema50_vs_ema200": "below",
        "enabled": True,
        ...
        "entry_trades": [1],
        "conditions": [
            {"indicator": "price_touches_ema20_15m_short", "operator": "==", "value": True},
            {"indicator": "ema3_below_ema9_15m", "operator": "==", "value": True},
            {"indicator": "ema9_below_ema20_15m", "operator": "==", "value": True},
            {"indicator": "ema3_ema9_gap_sufficient_15m", "operator": "==", "value": True},
            {"indicator": "ema20_slope_negative_15m", "operator": "==", "value": True},
        ],
        "logic": "AND",
        "notes": "Entrada rápida y óptima al retroceso en EMA20 con tendencia bajista intacta y separación de medias.",
    },
    ...
    },
    {
        ...
        "conditions": [
            ...
            {"indicator": "high_above_ema20_1h", "operator": "==", "value": True},
        ],
        "logic": "AND",
    ...
    },
    {
        ...
        "description": "HOT Momentum alcista C: BB Expanding (10%) + Low < EMA20 15m (20%) + Price < EMA9 15m (10%) + EMA3 > EMA9 (30%) + EMA9 > EMA20 (30%)",
        "direction": "long",
        "market_type": ["crypto_spot", "crypto_futures"],
        "ema50_vs_ema200": "above",
        "enabled": True,
        ...
        "entry_trades": [1],
        "conditions": [
            {"indicator": "bb_expanding", "operator": "==", "value": True, "weight": 0.1},
            {"indicator": "low_below_ema20_15m", "operator": "==", "value": True, "weight": 0.2},
            {"indicator": "low_touched_ema9", "operator": "==", "value": True, "weight": 0.1},
            {"indicator": "ema3_above_ema9", "operator": "==", "value": True, "weight": 0.3},
            {"indicator": "ema9_above_ema20", "operator": "==", "value": True, "weight": 0.3},
        ],
        "logic": "AND",
        "notes": "HOT Momentum alcista C: Ajustado según UI configuration",
    },
    {
        "id": 1041,
        "rule_code": "BbHotC",
    ...
    },
    {
        ...
        "conditions": [
            ...
            {"indicator": "bb_lower_slope_negative", "operator": "==", "value": True},
            {"indicator": "bb_upper_slope_negative", "operator": "==", "value": True},
            {"indicator": "reversal_confirmation_short", "operator": "==", "value": True},
        ],
        "logic": "AND",
        "notes": "Estrategia Fast Track de 5 minutos.",
    },
    {
        ...
        "conditions": [
            ...
            {"indicator": "ema20_angle", "operator": ">", "value": 0},
            {"indicator": "ema3_above_ema9_1h", "operator": "==", "value": True},
            {"indicator": "di_plus_above_di_minus", "operator": "==", "value": True},
            {"indicator": "bb_upper_slope_positive", "operator": "==", "value": True},
        ],
        "logic": "AND",
...
def build_market_data_dict(
    ...
    data = {
        ...
        "di_plus_above_di_minus": float(last.get("plus_di", 0)) > float(last.get("minus_di", 0)) if pd.notna(last.get("plus_di")) and pd.notna(last.get("minus_di")) else False,
        "di_minus_above_di_plus": float(last.get("minus_di", 0)) > float(last.get("plus_di", 0)) if pd.notna(last.get("plus_di")) and pd.notna(last.get("minus_di")) else False,
