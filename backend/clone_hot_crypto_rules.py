...
def clone_rule(original_code, new_code, new_name):
    ...
    if not exists.data:
        ...
        new_rule['description'] = (new_rule['description'] or "") + " (Crypto 15m Filter)"
...
clone_rule('AaHot', 'AaHotC', 'HOT Momentum LONG Cripto')
clone_rule('BbHot', 'BbHotC', 'HOT Momentum SHORT Cripto')
